...
Build pages based on provided Figma designs using specified components.

## Usage

When calling this agent, provide:
1. **Figma Design URL**: The link to the Figma design to implement
2. **Component Paths**: List of reusable components to use (optional)

## Workflow

### 1. Analyze the Design Visually

Look at the Figma Design and identify:
...
Use shadcn MCP via context7 to verify components exist:
...
- **Use shadcn MCP via context7 MCP** to verify components exist and get install commands
