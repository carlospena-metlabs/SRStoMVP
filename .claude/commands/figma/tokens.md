...
export const navigation: NavSection[] = [
  ...
  },
  {
    title: "Components",
    items: [
      // Components will be added here by /figma:components
    ]
  }
]
```
...
└── styleguide/
    ...
    ├── navigation.ts        # Navigation config (editable by /figma:components)
    ├── page.tsx             # All design tokens in one page
    └── components/
        └── [name]/
            └── page.tsx     # Individual components (added by /figma:components)
```
...
- Design system ready for /figma:components and page development
