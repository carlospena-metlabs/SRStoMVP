...
Add components to the project using shadcn/ui, optionally from Figma designs.

## Input (Optional)

Figma URL: [URL or leave empty for generic component]
...
- **PRIORITIZE importing existing components** from design system over creating new ones
